...
export const PROPERTIES: Property[] = [
  {
    id: 'prop-001',
    title: 'Luxury Apartment in Petralona',
    ...
    imageUrls: [
      'petralona/photo_1.png',
      'petralona/photo_2.png',
      'petralona/photo_3.png',
      'petralona/photo_4.png',
      'petralona/photo_5.png',
      'petralona/photo_6.png',
      'petralona/photo_7.png',
    ],
    description:
      'Fully renovated luxury apartment in the heart of Petralona. Modern amenities, high ceilings, and premium finishes throughout.',
    features: ['Renovated 2022', 'Central Heating', 'Air Conditioning', 'Balcony', 'Parking'],
    isFeatured: true,
  },
  // {
  //   id: 'prop-002',
